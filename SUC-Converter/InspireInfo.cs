...
namespace SUC_Converter
{
    ...
    public partial class InspireResourceResourceParam
    {
        ...
        private byte assignResourceIDField;
        ...
        public decimal NearPlane
        {
            get
            {
                return this.nearPlaneField;
            }
            set
            {
                this.nearPlaneField = value;
            }
        }
        ...
        /// <remarks/>
        public byte ShadowMapBoxHeight
        {
            get
            {
    ...
    public partial class InspireResourceResourceParamCPostEffectInfoFunctionCurveKeyFrame
    {
        ...
        private byte valueUpperBiasField;

        private byte valueLowerBiasField;

        private byte slopeLField;

        private byte slopeRField;

        private byte slopeLUpperBiasField;

        private byte slopeLLowerBiasField;

        private byte slopeRUpperBiasField;

        private byte slopeRLowerBiasField;
